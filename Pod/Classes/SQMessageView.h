...
#define SQMessageViewAlpha 0.95




@interface SQMessageView : UIView
...
@property (nonatomic, assign) SQMessageNotificationPosition messagePosition;
...
- (id)initWithTitle:(NSString *)title
           subtitle:(NSString *)subtitle
              image:(UIImage *)image
               type:(SQMessageNotificationType)notificationType
